...
HOME_TEXT = "<b>Hey  [{}](tg://user?id={}) 🙂\nI'M Streamer Bot.\nTo Play/Stream Videos In Chats !\nPress Help For More Info :)</b>"
    ...
    with suppress(MessageIdInvalid, MessageNotModified):
        ...
        if Config.DATABASE_URI and var in ["STARTUP_STREAM", "CHAT", "LOG_GROUP", "REPLY_MESSAGE", "DELAY", "RECORDING_DUMP", "QUALITY"]:      
            ...
            if not Config.HEROKU_APP:
                buttons = [[InlineKeyboardButton('Heroku API_KEY', url='https://dashboard.heroku.com/account/applications/authorizations/new'), InlineKeyboardButton('✗ ᴄʟᴏꜱᴇ ✗', callback_data='close'),]]
                await m.edit(
